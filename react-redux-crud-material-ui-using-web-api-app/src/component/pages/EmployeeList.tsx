...
export const EmployeeList=()=>{
    ...
    const { data: employeeRecords, loading, error, isError, apiResponse } = EmployeeHook(); 
    ...
    const filteredData=useMemo(()=>{
      if(Array.isArray(employeeRecords)){
        return employeeRecords.filter((x:any)=>!search || x.firstName.includes(search))
      }
      else{
        return [];
      }
    ...
    const deleteEmployee=(record:any)=>{    
      dispatch(EmployeeAction.deleteEmployee(record.employeeId))
    }

    useEffect(() => {
      dispatch(EmployeeAction.fetchEmployee());
    }, []); 
          ...
          <Container>
            ...
            <Paper className={classes.root}>
                ...
                <Table stickyHeader aria-label="sticky table">
                    ...
                    <TableBody>
                    {Array.isArray(filteredData)?filteredData.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((record:IEmployee) => {
                        return (
